...
export default function App() {
  const { loadUser, isAuthenticated, demoMode, setDemoMode, setDevMode, setHasMapsKey, setMapsConfig, setServerTimezone, setAppRequireMfa, setTripRemindersEnabled } = useAuthStore()
